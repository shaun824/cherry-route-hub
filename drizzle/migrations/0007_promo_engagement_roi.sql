ALTER TABLE public.promos
  ADD COLUMN estimated_click_value_cents integer NOT NULL DEFAULT 0;

ALTER TABLE public.promos
  ADD CONSTRAINT promos_estimated_click_value_nonnegative
  CHECK (estimated_click_value_cents >= 0);

CREATE INDEX analytics_events_promo_engagement_idx
  ON public.analytics_events (event_name, created_at DESC)
  WHERE event_name IN ('promo_impression', 'promo_open', 'promo_copy', 'promo_outbound');
